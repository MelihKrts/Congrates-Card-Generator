        ...
        <section className="w-full  bg-[4A4238] pt-4 mt-16 mb-14">
            <div className="container justify-center flex flex-col  ">
                ...
                <div className="w-full my-4">
                    ...
                    <div
                        className="w-3/4 xs:w-3/4 sm:w-3/4 md:w-1/2 lg:w-1/2  aspect-[3/2] mx-4 my-4 max-w-[600px] rounded-lg flex items-center justify-center relative overflow-hidden bg-cover bg-no-repeat"
                        style={{
